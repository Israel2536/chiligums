 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wc(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Ac(){const r=Is()?.forceEnvironment;if(r==="node")return!0;if(r==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Rc(){return!Ac()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Cc(){try{return typeof indexedDB=="object"}catch{return!1}}function Sc(){return new Promise((r,t)=>{try{let e=!0;const n="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(n);i.onsuccess=()=>{i.result.close(),e||self.indexedDB.deleteDatabase(n),r(!0)},i.onupgradeneeded=()=>{e=!1},i.onerror=()=>{t(i.error?.message||"")}}catch(e){t(e)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var q;(function(r){r[r.DEBUG=0]="DEBUG",r[r.VERBOSE=1]="VERBOSE",r[r.INFO=2]="INFO",r[r.WARN=3]="WARN",r[r.ERROR=4]="ERROR",r[r.SILENT=5]="SILENT"})(q||(q={}));const Mc={debug:q.DEBUG,verbose:q.VERBOSE,info:q.INFO,warn:q.WARN,error:q.ERROR,silent:q.SILENT},Lc=q.INFO,Fc={[q.DEBUG]:"log",[q.VERBOSE]:"log",[q.INFO]:"info",[q.WARN]:"warn",[q.ERROR]:"error"},Uc=(r,t,...e)=>{if(t<r.logLevel)return;const n=new Date().toISOString(),i=Fc[t];if(i)console[i](`[${n}]  ${r.name}:`,...e);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class ha{constructor(t){this.name=t,this._logLevel=Lc,this._logHandler=Uc,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in q))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?Mc[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,q.DEBUG,...t),this._logHandler(this,q.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,q.VERBOSE,...t),this._logHandler(this,q.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,q.INFO,...t),this._logHandler(this,q.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,q.WARN,...t),this._logHandler(this,q.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,q.ERROR,...t),this._logHandler(this,q.ERROR,...t)}}const Bc=(r,t)=>t.some(e=>r instanceof e);let Ji,Zi;function qc(){return Ji||(Ji=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function jc(){return Zi||(Zi=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const da=new WeakMap,Yr=new WeakMap,fa=new WeakMap,qr=new WeakMap,As=new WeakMap;function $c(r){const t=new Promise((e,n)=>{const i=()=>{r.removeEventListener("success",o),r.removeEventListener("error",u)},o=()=>{e(Ht(r.result)),i()},u=()=>{n(r.error),i()};r.addEventListener("success",o),r.addEventListener("error",u)});return t.then(e=>{e instanceof IDBCursor&&da.set(e,r)}).catch(()=>{}),As.set(t,r),t}function zc(r){if(Yr.has(r))return;const t=new Promise((e,n)=>{const i=()=>{r.removeEventListener("complete",o),r.removeEventListener("error",u),r.removeEventListener("abort",u)},o=()=>{e(),i()},u=()=>{n(r.error||new DOMException("AbortError","AbortError")),i()};r.addEventListener("complete",o),r.addEventListener("error",u),r.addEventListener("abort",u)});Yr.set(r,t)}let Jr={get(r,t,e){if(r instanceof IDBTransaction){if(t==="done")return Yr.get(r);if(t==="objectStoreNames")return r.objectStoreNames||fa.get(r);if(t==="store")return e.objectStoreNames[1]?void 0:e.objectStore(e.objectStoreNames[0])}return Ht(r[t])},set(r,t,e){return r[t]=e,!0},has(r,t){return r instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in r}};function Hc(r){Jr=r(Jr)}function Gc(r){return r===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...e){const n=r.call(jr(this),t,...e);return fa.set(n,t.sort?t.sort():[t]),Ht(n)}:jc().includes(r)?function(...t){return r.apply(jr(this),t),Ht(da.get(this))}:function(...t){return Ht(r.apply(jr(this),t))}}function Kc(r){return typeof r=="function"?Gc(r):(r instanceof IDBTransaction&&zc(r),Bc(r,qc())?new Proxy(r,Jr):r)}function Ht(r){if(r instanceof IDBRequest)return $c(r);if(qr.has(r))return qr.get(r);const t=Kc(r);return t!==r&&(qr.set(r,t),As.set(t,r)),t}const jr=r=>As.get(r);function Qc(r,t,{blocked:e,upgrade:n,blocking:i,terminated:o}={}){const u=indexedDB.open(r,t),l=Ht(u);return n&&u.addEventListener("upgradeneeded",d=>{n(Ht(u.result),d.oldVersion,d.newVersion,Ht(u.transaction),d)}),e&&u.addEventListener("blocked",d=>e(d.oldVersion,d.newVersion,d)),l.then(d=>{o&&d.addEventListener("close",()=>o()),i&&d.addEventListener("versionchange",f=>i(f.oldVersion,f.newVersion,f))}).catch(()=>{}),l}const Wc=["get","getKey","getAll","getAllKeys","count"],Xc=["put","add","delete","clear"],$r=new Map;function to(r,t){if(!(r instanceof IDBDatabase&&!(t in r)&&typeof t=="string"))return;if($r.get(t))return $r.get(t);const e=t.replace(/FromIndex$/,""),n=t!==e,i=Xc.includes(e);if(!(e in(n?IDBIndex:IDBObjectStore).prototype)||!(i||Wc.includes(e)))return;const o=async function(u,...l){const d=this.transaction(u,i?"readwrite":"readonly");let f=d.store;return n&&(f=f.index(l.shift())),(await Promise.all([f[e](...l),i&&d.done]))[0]};return $r.set(t,o),o}Hc(r=>({...r,get:(t,e,n)=>to(t,e)||r.get(t,e,n),has:(t,e)=>!!to(t,e)||r.has(t,e)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yc{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(Jc(e)){const n=e.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(e=>e).join(" ")}}function Jc(r){return r.getComponent()?.type==="VERSION"}const Zr="@firebase/app",eo="0.14.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts="[DEFAULT]",Cl={[Zr]:"fire-core",[Zc]:"fire-core-compat",[el]:"fire-analytics",[tl]:"fire-analytics-compat",[rl]:"fire-app-check",[nl]:"fire-app-check-compat",[sl]:"fire-auth",[il]:"fire-auth-compat",[ol]:"fire-rtdb",[al]:"fire-data-connect",[ul]:"fire-rtdb-compat",[cl]:"fire-fn",[ll]:"fire-fn-compat",[hl]:"fire-iid",[dl]:"fire-iid-compat",[fl]:"fire-fcm",[pl]:"fire-fcm-compat",[ml]:"fire-perf",[gl]:"fire-perf-compat",[_l]:"fire-rc",[yl]:"fire-rc-compat",[El]:"fire-gcs",[Tl]:"fire-gcs-compat",[vl]:"fire-fst",[wl]:"fire-fst-compat",[Il]:"fire-vertex","fire-js":"fire-js",[Al]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ll=1024,Fl=30;class Ul{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new ql(e),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){try{const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),n=so();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===n||this._heartbeatsCache.heartbeats.some(i=>i.date===n))return;if(this._heartbeatsCache.heartbeats.push({date:n,agent:e}),this._heartbeatsCache.heartbeats.length>Fl){const i=jl(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(i,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(t){Ot.warn(t)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=so(),{heartbeatsToSend:e,unsentEntries:n}=Bl(this._heartbeatsCache.heartbeats),i=Qn(JSON.stringify({version:2,heartbeats:e}));return this._heartbeatsCache.lastSentHeartbeatDate=t,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(t){return Ot.warn(t),""}}}function so(){return new Date().toISOString().substring(0,10)}function Bl(r,t=Ll){const e=[];let n=r.slice();for(const i of r){const o=e.find(u=>u.agent===i.agent);if(o){if(o.dates.push(i.date),io(e)>t){o.dates.pop();break}}else if(e.push({agent:i.agent,dates:[i.date]}),io(e)>t){e.pop();break}n=n.slice(1)}return{heartbeatsToSend:e,unsentEntries:n}}class ql{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Cc()?Sc().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await Ml(this.app);return e?.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const n=await this.read();return ro(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const n=await this.read();return ro(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...t.heartbeats]})}else return}}function io(r){return Qn(JSON.stringify({version:2,heartbeats:r})).length}function jl(r){if(r.length===0)return-1;let t=0,e=r[0].date;for(let n=1;n<r.length;n++)r[n].date<e&&(e=r[n].date,t=n);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $l(r){Yn(new cn("platform-logger",t=>new Yc(t),"PRIVATE")),Yn(new cn("heartbeat",t=>new Ul(t),"PRIVATE")),ve(Zr,eo,r),ve(Zr,eo,"esm2020"),ve("fire-js","")}$l("");var zl="firebase",Hl="12.3.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ve(zl,Hl,"app");var oo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var ya,tn,Ea,$n,ns,Ta,va,Ia;(function(){var r,t=Object.defineProperty;function e(s){s=[typeof globalThis=="object"&&globalThis,s,typeof window=="object"&&window,typeof self=="object"&&self,typeof On=="object"&&On];for(var a=0;a<s.length;++a){var c=s[a];if(c&&c.Math==Math)return c}throw Error("Cannot find global object")}var n=e(this);function i(s,a){if(a)t:{var c=n;s=s.split(".");for(var h=0;h<s.length-1;h++){var v=s[h];if(!(v in c))break t;c=c[v]}s=s[s.length-1],h=c[s],a=a(h),a!=h&&a!=null&&t(c,s,{configurable:!0,writable:!0,value:a})}}i("Symbol.dispose",function(s){return s||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(s){return s||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(s){return s||function(a){var c=[],h;for(h in a)Object.prototype.hasOwnProperty.call(a,h)&&c.push([h,a[h]]);return c}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},u=this||self;function l(s){var a=typeof s;return a=="object"&&s!=null||a=="function"}function d(s,a,c){return s.call.apply(s.bind,arguments)}function f(s,a,c){return f=d,f.apply(null,arguments)}function _(s,a){var c=Array.prototype.slice.call(arguments,1);return function(){var h=c.slice();return h.push.apply(h,arguments),s.apply(this,h)}}function w(s,a){function c(){}c.prototype=a.prototype,s.Z=a.prototype,s.prototype=new c,s.prototype.constructor=s,s.Ob=function(h,v,A){for(var b=Array(arguments.length-2),F=2;F<arguments.length;F++)b[F-2]=arguments[F];return a.prototype[v].apply(h,b)}}var R=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?s=>s&&AsyncContext.Snapshot.wrap(s):s=>s;function S(s){const a=s.length;if(a>0){const c=Array(a);for(let h=0;h<a;h++)c[h]=s[h];return c}return[]}function x(s,a){for(let h=1;h<arguments.length;h++){const v=arguments[h];var c=typeof v;if(c=c!="object"?c:v?Array.isArray(v)?"array":c:"null",c=="array"||c=="object"&&typeof v.length=="number"){c=s.length||0;const A=v.length||0;s.length=c+A;for(let b=0;b<A;b++)s[c+b]=v[b]}else s.push(v)}}class L{constructor(a,c){this.i=a,this.j=c,this.h=0,this.g=null}get(){let a;return this.h>0?(this.h--,a=this.g,this.g=a.next,a.next=null):a=this.i(),a}}function D(s){u.setTimeout(()=>{throw s},0)}function Q(){var s=E;let a=null;return s.g&&(a=s.g,s.g=s.g.next,s.g||(s.h=null),a.next=null),a}class G{constructor(){this.h=this.g=null}add(a,c){const h=H.get();h.set(a,c),this.h?this.h.next=h:this.g=h,this.h=h}}var H=new L(()=>new gt,s=>s.reset());class gt{constructor(){this.next=this.g=this.h=null}set(a,c){this.h=a,this.g=c,this.next=null}reset(){this.next=this.g=this.h=null}}let Tt,at=!1,E=new G,p=()=>{const s=Promise.resolve(void 0);Tt=()=>{s.then(g)}};function g(){for(var s;s=Q();){try{s.h.call(s.g)}catch(c){D(c)}var a=H;a.j(s),a.h<100&&(a.h++,s.next=a.g,a.g=s)}at=!1}function T(){this.u=this.u,this.C=this.C}T.prototype.u=!1,T.prototype.dispose=function(){this.u||(this.u=!0,this.N())},T.prototype[Symbol.dispose]=function(){this.dispose()},T.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function y(s,a){this.type=s,this.g=this.target=a,this.defaultPrevented=!1}y.prototype.h=function(){this.defaultPrevented=!0};var I=(function(){if(!u.addEventListener||!Object.defineProperty)return!1;var s=!1,a=Object.defineProperty({},"passive",{get:function(){s=!0}});try{const c=()=>{};u.addEventListener("test",c,a),u.removeEventListener("test",c,a)}catch{}return s})();function m(s){return/^[\s\xa0]*$/.test(s)}function vt(s,a){y.call(this,s?s.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,s&&this.init(s,a)}w(vt,y),vt.prototype.init=function(s,a){const c=this.type=s.type,h=s.changedTouches&&s.changedTouches.length?s.changedTouches[0]:null;this.target=s.target||s.srcElement,this.g=a,a=s.relatedTarget,a||(c=="mouseover"?a=s.fromElement:c=="mouseout"&&(a=s.toElement)),this.relatedTarget=a,h?(this.clientX=h.clientX!==void 0?h.clientX:h.pageX,this.clientY=h.clientY!==void 0?h.clientY:h.pageY,this.screenX=h.screenX||0,this.screenY=h.screenY||0):(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0),this.button=s.button,this.key=s.key||"",this.ctrlKey=s.ctrlKey,this.altKey=s.altKey,this.shiftKey=s.shiftKey,this.metaKey=s.metaKey,this.pointerId=s.pointerId||0,this.pointerType=s.pointerType,this.state=s.state,this.i=s,s.defaultPrevented&&vt.Z.h.call(this)},vt.prototype.h=function(){vt.Z.h.call(this);const s=this.i;s.preventDefault?s.preventDefault():s.returnValue=!1};var ne="closure_listenable_"+(Math.random()*1e6|0),bu=0;function Pu(s,a,c,h,v){this.listener=s,this.proxy=null,this.src=a,this.type=c,this.capture=!!h,this.ha=v,this.key=++bu,this.da=this.fa=!1}function Tn(s){s.da=!0,s.listener=null,s.proxy=null,s.src=null,s.ha=null}function vn(s,a,c){for(const h in s)a.call(c,s[h],h,s)}function Vu(s,a){for(const c in s)a.call(void 0,s[c],c,s)}function Qs(s){const a={};for(const c in s)a[c]=s[c];return a}const Ws="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Xs(s,a){let c,h;for(let v=1;v<arguments.length;v++){h=arguments[v];for(c in h)s[c]=h[c];for(let A=0;A<Ws.length;A++)c=Ws[A],Object.prototype.hasOwnProperty.call(h,c)&&(s[c]=h[c])}}function In(s){this.src=s,this.g={},this.h=0}In.prototype.add=function(s,a,c,h,v){const A=s.toString();s=this.g[A],s||(s=this.g[A]=[],this.h++);const b=yr(s,a,h,v);return b>-1?(a=s[b],c||(a.fa=!1)):(a=new Pu(a,this.src,A,!!h,v),a.fa=c,s.push(a)),a};function _r(s,a){const c=a.type;if(c in s.g){var h=s.g[c],v=Array.prototype.indexOf.call(h,a,void 0),A;(A=v>=0)&&Array.prototype.splice.call(h,v,1),A&&(Tn(a),s.g[c].length==0&&(delete s.g[c],s.h--))}}function yr(s,a,c,h){for(let v=0;v<s.length;++v){const A=s[v];if(!A.da&&A.listener==a&&A.capture==!!c&&A.ha==h)return v}return-1}var Er="closure_lm_"+(Math.random()*1e6|0),Tr={};function Ys(s,a,c,h,v){if(Array.isArray(a)){for(let A=0;A<a.length;A++)Ys(s,a[A],c,h,v);return null}return c=ti(c),s&&s[ne]?s.J(a,c,l(h)?!!h.capture:!1,v):Du(s,a,c,!1,h,v)}function Du(s,a,c,h,v,A){if(!a)throw Error("Invalid event type");const b=l(v)?!!v.capture:!!v;let F=Ir(s);if(F||(s[Er]=F=new In(s)),c=F.add(a,c,h,b,A),c.proxy)return c;if(h=Nu(),c.proxy=h,h.src=s,h.listener=c,s.addEventListener)I||(v=b),v===void 0&&(v=!1),s.addEventListener(a.toString(),h,v);else if(s.attachEvent)s.attachEvent(Zs(a.toString()),h);else if(s.addListener&&s.removeListener)s.addListener(h);else throw Error("addEventListener and attachEvent are unavailable.");return c}function Nu(){function s(c){return a.call(s.src,s.listener,c)}const a=ku;return s}function Js(s,a,c,h,v){if(Array.isArray(a))for(var A=0;A<a.length;A++)Js(s,a[A],c,h,v);else h=l(h)?!!h.capture:!!h,c=ti(c),s&&s[ne]?(s=s.i,A=String(a).toString(),A in s.g&&(a=s.g[A],c=yr(a,c,h,v),c>-1&&(Tn(a[c]),Array.prototype.splice.call(a,c,1),a.length==0&&(delete s.g[A],s.h--)))):s&&(s=Ir(s))&&(a=s.g[a.toString()],s=-1,a&&(s=yr(a,c,h,v)),(c=s>-1?a[s]:null)&&vr(c))}function vr(s){if(typeof s!="number"&&s&&!s.da){var a=s.src;if(a&&a[ne])_r(a.i,s);else{var c=s.type,h=s.proxy;a.removeEventListener?a.removeEventListener(c,h,s.capture):a.detachEvent?a.detachEvent(Zs(c),h):a.addListener&&a.removeListener&&a.removeListener(h),(c=Ir(a))?(_r(c,s),c.h==0&&(c.src=null,a[Er]=null)):Tn(s)}}}function Zs(s){return s in Tr?Tr[s]:Tr[s]="on"+s}function ku(s,a){if(s.da)s=!0;else{a=new vt(a,this);const c=s.listener,h=s.ha||s.src;s.fa&&vr(s),s=c.call(h,a)}return s}function Ir(s){return s=s[Er],s instanceof In?s:null}var wr="__closure_events_fn_"+(Math.random()*1e9>>>0);function ti(s){return typeof s=="function"?s:(s[wr]||(s[wr]=function(a){return s.handleEvent(a)}),s[wr])}function dt(){T.call(this),this.i=new In(this),this.M=this,this.G=null}w(dt,T),dt.prototype[ne]=!0,dt.prototype.removeEventListener=function(s,a,c,h){Js(this,s,a,c,h)};function _t(s,a){var c,h=s.G;if(h)for(c=[];h;h=h.G)c.push(h);if(s=s.M,h=a.type||a,typeof a=="string")a=new y(a,s);else if(a instanceof y)a.target=a.target||s;else{var v=a;a=new y(h,s),Xs(a,v)}v=!0;let A,b;if(c)for(b=c.length-1;b>=0;b--)A=a.g=c[b],v=wn(A,h,!0,a)&&v;if(A=a.g=s,v=wn(A,h,!0,a)&&v,v=wn(A,h,!1,a)&&v,c)for(b=0;b<c.length;b++)A=a.g=c[b],v=wn(A,h,!1,a)&&v}dt.prototype.N=function(){if(dt.Z.N.call(this),this.i){var s=this.i;for(const a in s.g){const c=s.g[a];for(let h=0;h<c.length;h++)Tn(c[h]);delete s.g[a],s.h--}}this.G=null},dt.prototype.J=function(s,a,c,h){return this.i.add(String(s),a,!1,c,h)},dt.prototype.K=function(s,a,c,h){return this.i.add(String(s),a,!0,c,h)};function wn(s,a,c,h){if(a=s.i.g[String(a)],!a)return!0;a=a.concat();let v=!0;for(let A=0;A<a.length;++A){const b=a[A];if(b&&!b.da&&b.capture==c){const F=b.listener,st=b.ha||b.src;b.fa&&_r(s.i,b),v=F.call(st,h)!==!1&&v}}return v&&!h.defaultPrevented}function xu(s,a){if(typeof s!="function")if(s&&typeof s.handleEvent=="function")s=f(s.handleEvent,s);else throw Error("Invalid listener argument");return Number(a)>2147483647?-1:u.setTimeout(s,a||0)}function ei(s){s.g=xu(()=>{s.g=null,s.i&&(s.i=!1,ei(s))},s.l);const a=s.h;s.h=null,s.m.apply(null,a)}class Ou extends T{constructor(a,c){super(),this.m=a,this.l=c,this.h=null,this.i=!1,this.g=null}j(a){this.h=arguments,this.g?this.i=!0:ei(this)}N(){super.N(),this.g&&(u.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Fe(s){T.call(this),this.h=s,this.g={}}w(Fe,T);var ni=[];function ri(s){vn(s.g,function(a,c){this.g.hasOwnProperty(c)&&vr(a)},s),s.g={}}Fe.prototype.N=function(){Fe.Z.N.call(this),ri(this)},Fe.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ar=u.JSON.stringify,Mu=u.JSON.parse,Lu=class{stringify(s){return u.JSON.stringify(s,void 0)}parse(s){return u.JSON.parse(s,void 0)}};function si(){}function ii(){}var Ue={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Rr(){y.call(this,"d")}w(Rr,y);function Cr(){y.call(this,"c")}w(Cr,y);var re={},oi=null;function An(){return oi=oi||new dt}re.Ia="serverreachability";function ai(s){y.call(this,re.Ia,s)}w(ai,y);function Be(s){const a=An();_t(a,new ai(a))}re.STAT_EVENT="statevent";function ui(s,a){y.call(this,re.STAT_EVENT,s),this.stat=a}w(ui,y);function yt(s){const a=An();_t(a,new ui(a,s))}re.Ja="timingevent";function ci(s,a){y.call(this,re.Ja,s),this.size=a}w(ci,y);function qe(s,a){if(typeof s!="function")throw Error("Fn must not be null and must be a function");return u.setTimeout(function(){s()},a)}function je(){this.g=!0}je.prototype.ua=function(){this.g=!1};function Fu(s,a,c,h,v,A){s.info(function(){if(s.g)if(A){var b="",F=A.split("&");for(let z=0;z<F.length;z++){var st=F[z].split("=");if(st.length>1){const ut=st[0];st=st[1];const bt=ut.split("_");b=bt.length>=2&&bt[1]=="type"?b+(ut+"="+st+"&"):b+(ut+"=redacted&")}}}else b=null;else b=A;return"XMLHTTP REQ ("+h+") [attempt "+v+"]: "+a+`
`+c+`
`+b})}function Uu(s,a,c,h,v,A,b){s.info(function(){return"XMLHTTP RESP ("+h+") [ attempt "+v+"]: "+a+`
`+c+`
`+A+" "+b})}function pe(s,a,c,h){s.info(function(){return"XMLHTTP TEXT ("+a+"): "+qu(s,c)+(h?" "+h:"")})}function Bu(s,a){s.info(function(){return"TIMEOUT: "+a})}je.prototype.info=function(){};function qu(s,a){if(!s.g)return a;if(!a)return null;try{const A=JSON.parse(a);if(A){for(s=0;s<A.length;s++)if(Array.isArray(A[s])){var c=A[s];if(!(c.length<2)){var h=c[1];if(Array.isArray(h)&&!(h.length<1)){var v=h[0];if(v!="noop"&&v!="stop"&&v!="close")for(let b=1;b<h.length;b++)h[b]=""}}}}return Ar(A)}catch{return a}}var Rn={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},li={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},hi;function Sr(){}w(Sr,si),Sr.prototype.g=function(){return new XMLHttpRequest},hi=new Sr;function $e(s){return encodeURIComponent(String(s))}function ju(s){var a=1;s=s.split(":");const c=[];for(;a>0&&s.length;)c.push(s.shift()),a--;return s.length&&c.push(s.join(":")),c}function Lt(s,a,c,h){this.j=s,this.i=a,this.l=c,this.S=h||1,this.V=new Fe(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new di}function di(){this.i=null,this.g="",this.h=!1}var fi={},br={};function Pr(s,a,c){s.M=1,s.A=Sn(St(a)),s.u=c,s.R=!0,pi(s,null)}function pi(s,a){s.F=Date.now(),Cn(s),s.B=St(s.A);var c=s.B,h=s.S;Array.isArray(h)||(h=[String(h)]),Si(c.i,"t",h),s.C=0,c=s.j.L,s.h=new di,s.g=Hi(s.j,c?a:null,!s.u),s.P>0&&(s.O=new Ou(f(s.Y,s,s.g),s.P)),a=s.V,c=s.g,h=s.ba;var v="readystatechange";Array.isArray(v)||(v&&(ni[0]=v.toString()),v=ni);for(let A=0;A<v.length;A++){const b=Ys(c,v[A],h||a.handleEvent,!1,a.h||a);if(!b)break;a.g[b.key]=b}a=s.J?Qs(s.J):{},s.u?(s.v||(s.v="POST"),a["Content-Type"]="application/x-www-form-urlencoded",s.g.ea(s.B,s.v,s.u,a)):(s.v="GET",s.g.ea(s.B,s.v,null,a)),Be(),Fu(s.i,s.v,s.B,s.l,s.S,s.u)}Lt.prototype.ba=function(s){s=s.target;const a=this.O;a&&Bt(s)==3?a.j():this.Y(s)},Lt.prototype.Y=function(s){try{if(s==this.g)t:{const F=Bt(this.g),st=this.g.ya(),z=this.g.ca();if(!(F<3)&&(F!=3||this.g&&(this.h.h||this.g.la()||xi(this.g)))){this.K||F!=4||st==7||(st==8||z<=0?Be(3):Be(2)),Vr(this);var a=this.g.ca();this.X=a;var c=$u(this);if(this.o=a==200,Uu(this.i,this.v,this.B,this.l,this.S,F,a),this.o){if(this.U&&!this.L){e:{if(this.g){var h,v=this.g;if((h=v.g?v.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!m(h)){var A=h;break e}}A=null}if(s=A)pe(this.i,this.l,s,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Dr(this,s);else{this.o=!1,this.m=3,yt(12),se(this),ze(this);break t}}if(this.R){s=!0;let ut;for(;!this.K&&this.C<c.length;)if(ut=zu(this,c),ut==br){F==4&&(this.m=4,yt(14),s=!1),pe(this.i,this.l,null,"[Incomplete Response]");break}else if(ut==fi){this.m=4,yt(15),pe(this.i,this.l,c,"[Invalid Chunk]"),s=!1;break}else pe(this.i,this.l,ut,null),Dr(this,ut);if(mi(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),F!=4||c.length!=0||this.h.h||(this.m=1,yt(16),s=!1),this.o=this.o&&s,!s)pe(this.i,this.l,c,"[Invalid Chunked Response]"),se(this),ze(this);else if(c.length>0&&!this.W){this.W=!0;var b=this.j;b.g==this&&b.aa&&!b.P&&(b.j.info("Great, no buffering proxy detected. Bytes received: "+c.length),Ur(b),b.P=!0,yt(11))}}else pe(this.i,this.l,c,null),Dr(this,c);F==4&&se(this),this.o&&!this.K&&(F==4?qi(this.j,this):(this.o=!1,Cn(this)))}else sc(this.g),a==400&&c.indexOf("Unknown SID")>0?(this.m=3,yt(12)):(this.m=0,yt(13)),se(this),ze(this)}}}catch{}finally{}};function $u(s){if(!mi(s))return s.g.la();const a=xi(s.g);if(a==="")return"";let c="";const h=a.length,v=Bt(s.g)==4;if(!s.h.i){if(typeof TextDecoder>"u")return se(s),ze(s),"";s.h.i=new u.TextDecoder}for(let A=0;A<h;A++)s.h.h=!0,c+=s.h.i.decode(a[A],{stream:!(v&&A==h-1)});return a.length=0,s.h.g+=c,s.C=0,s.h.g}function mi(s){return s.g?s.v=="GET"&&s.M!=2&&s.j.Aa:!1}function zu(s,a){var c=s.C,h=a.indexOf(`
`,c);return h==-1?br:(c=Number(a.substring(c,h)),isNaN(c)?fi:(h+=1,h+c>a.length?br:(a=a.slice(h,h+c),s.C=h+c,a)))}Lt.prototype.cancel=function(){this.K=!0,se(this)};function Cn(s){s.T=Date.now()+s.H,gi(s,s.H)}function gi(s,a){if(s.D!=null)throw Error("WatchDog timer not null");s.D=qe(f(s.aa,s),a)}function Vr(s){s.D&&(u.clearTimeout(s.D),s.D=null)}Lt.prototype.aa=function(){this.D=null;const s=Date.now();s-this.T>=0?(Bu(this.i,this.B),this.M!=2&&(Be(),yt(17)),se(this),this.m=2,ze(this)):gi(this,this.T-s)};function ze(s){s.j.I==0||s.K||qi(s.j,s)}function se(s){Vr(s);var a=s.O;a&&typeof a.dispose=="function"&&a.dispose(),s.O=null,ri(s.V),s.g&&(a=s.g,s.g=null,a.abort(),a.dispose())}function Dr(s,a){try{var c=s.j;if(c.I!=0&&(c.g==s||Nr(c.h,s))){if(!s.L&&Nr(c.h,s)&&c.I==3){try{var h=c.Ba.g.parse(a)}catch{h=null}if(Array.isArray(h)&&h.length==3){var v=h;if(v[0]==0){t:if(!c.v){if(c.g)if(c.g.F+3e3<s.F)Nn(c),Vn(c);else break t;Fr(c),yt(18)}}else c.xa=v[1],0<c.xa-c.K&&v[2]<37500&&c.F&&c.A==0&&!c.C&&(c.C=qe(f(c.Va,c),6e3));Ei(c.h)<=1&&c.ta&&(c.ta=void 0)}else oe(c,11)}else if((s.L||c.g==s)&&Nn(c),!m(a))for(v=c.Ba.g.parse(a),a=0;a<v.length;a++){let z=v[a];const ut=z[0];if(!(ut<=c.K))if(c.K=ut,z=z[1],c.I==2)if(z[0]=="c"){c.M=z[1],c.ba=z[2];const bt=z[3];bt!=null&&(c.ka=bt,c.j.info("VER="+c.ka));const ae=z[4];ae!=null&&(c.za=ae,c.j.info("SVER="+c.za));const qt=z[5];qt!=null&&typeof qt=="number"&&qt>0&&(h=1.5*qt,c.O=h,c.j.info("backChannelRequestTimeoutMs_="+h)),h=c;const jt=s.g;if(jt){const xn=jt.g?jt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(xn){var A=h.h;A.g||xn.indexOf("spdy")==-1&&xn.indexOf("quic")==-1&&xn.indexOf("h2")==-1||(A.j=A.l,A.g=new Set,A.h&&(kr(A,A.h),A.h=null))}if(h.G){const Br=jt.g?jt.g.getResponseHeader("X-HTTP-Session-Id"):null;Br&&(h.wa=Br,K(h.J,h.G,Br))}}c.I=3,c.l&&c.l.ra(),c.aa&&(c.T=Date.now()-s.F,c.j.info("Handshake RTT: "+c.T+"ms")),h=c;var b=s;if(h.na=zi(h,h.L?h.ba:null,h.W),b.L){Ti(h.h,b);var F=b,st=h.O;st&&(F.H=st),F.D&&(Vr(F),Cn(F)),h.g=b}else Ui(h);c.i.length>0&&Dn(c)}else z[0]!="stop"&&z[0]!="close"||oe(c,7);else c.I==3&&(z[0]=="stop"||z[0]=="close"?z[0]=="stop"?oe(c,7):Lr(c):z[0]!="noop"&&c.l&&c.l.qa(z),c.A=0)}}Be(4)}catch{}}var Hu=class{constructor(s,a){this.g=s,this.map=a}};function _i(s){this.l=s||10,u.PerformanceNavigationTiming?(s=u.performance.getEntriesByType("navigation"),s=s.length>0&&(s[0].nextHopProtocol=="hq"||s[0].nextHopProtocol=="h2")):s=!!(u.chrome&&u.chrome.loadTimes&&u.chrome.loadTimes()&&u.chrome.loadTimes().wasFetchedViaSpdy),this.j=s?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function yi(s){return s.h?!0:s.g?s.g.size>=s.j:!1}function Ei(s){return s.h?1:s.g?s.g.size:0}function Nr(s,a){return s.h?s.h==a:s.g?s.g.has(a):!1}function kr(s,a){s.g?s.g.add(a):s.h=a}function Ti(s,a){s.h&&s.h==a?s.h=null:s.g&&s.g.has(a)&&s.g.delete(a)}_i.prototype.cancel=function(){if(this.i=vi(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const s of this.g.values())s.cancel();this.g.clear()}};function vi(s){if(s.h!=null)return s.i.concat(s.h.G);if(s.g!=null&&s.g.size!==0){let a=s.i;for(const c of s.g.values())a=a.concat(c.G);return a}return S(s.i)}var Ii=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Gu(s,a){if(s){s=s.split("&");for(let c=0;c<s.length;c++){const h=s[c].indexOf("=");let v,A=null;h>=0?(v=s[c].substring(0,h),A=s[c].substring(h+1)):v=s[c],a(v,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function Ft(s){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let a;s instanceof Ft?(this.l=s.l,He(this,s.j),this.o=s.o,this.g=s.g,Ge(this,s.u),this.h=s.h,xr(this,bi(s.i)),this.m=s.m):s&&(a=String(s).match(Ii))?(this.l=!1,He(this,a[1]||"",!0),this.o=Ke(a[2]||""),this.g=Ke(a[3]||"",!0),Ge(this,a[4]),this.h=Ke(a[5]||"",!0),xr(this,a[6]||"",!0),this.m=Ke(a[7]||"")):(this.l=!1,this.i=new We(null,this.l))}Ft.prototype.toString=function(){const s=[];var a=this.j;a&&s.push(Qe(a,wi,!0),":");var c=this.g;return(c||a=="file")&&(s.push("//"),(a=this.o)&&s.push(Qe(a,wi,!0),"@"),s.push($e(c).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),c=this.u,c!=null&&s.push(":",String(c))),(c=this.h)&&(this.g&&c.charAt(0)!="/"&&s.push("/"),s.push(Qe(c,c.charAt(0)=="/"?Wu:Qu,!0))),(c=this.i.toString())&&s.push("?",c),(c=this.m)&&s.push("#",Qe(c,Yu)),s.join("")},Ft.prototype.resolve=function(s){const a=St(this);let c=!!s.j;c?He(a,s.j):c=!!s.o,c?a.o=s.o:c=!!s.g,c?a.g=s.g:c=s.u!=null;var h=s.h;if(c)Ge(a,s.u);else if(c=!!s.h){if(h.charAt(0)!="/")if(this.g&&!this.h)h="/"+h;else{var v=a.h.lastIndexOf("/");v!=-1&&(h=a.h.slice(0,v+1)+h)}if(v=h,v==".."||v==".")h="";else if(v.indexOf("./")!=-1||v.indexOf("/.")!=-1){h=v.lastIndexOf("/",0)==0,v=v.split("/");const A=[];for(let b=0;b<v.length;){const F=v[b++];F=="."?h&&b==v.length&&A.push(""):F==".."?((A.length>1||A.length==1&&A[0]!="")&&A.pop(),h&&b==v.length&&A.push("")):(A.push(F),h=!0)}h=A.join("/")}else h=v}return c?a.h=h:c=s.i.toString()!=="",c?xr(a,bi(s.i)):c=!!s.m,c&&(a.m=s.m),a};function St(s){return new Ft(s)}function He(s,a,c){s.j=c?Ke(a,!0):a,s.j&&(s.j=s.j.replace(/:$/,""))}function Ge(s,a){if(a){if(a=Number(a),isNaN(a)||a<0)throw Error("Bad port number "+a);s.u=a}else s.u=null}function xr(s,a,c){a instanceof We?(s.i=a,Ju(s.i,s.l)):(c||(a=Qe(a,Xu)),s.i=new We(a,s.l))}function K(s,a,c){s.i.set(a,c)}function Sn(s){return K(s,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),s}function Ke(s,a){return s?a?decodeURI(s.replace(/%25/g,"%2525")):decodeURIComponent(s):""}function Qe(s,a,c){return typeof s=="string"?(s=encodeURI(s).replace(a,Ku),c&&(s=s.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),s):null}function Ku(s){return s=s.charCodeAt(0),"%"+(s>>4&15).toString(16)+(s&15).toString(16)}var wi=/[#\/\?@]/g,Qu=/[#\?:]/g,Wu=/[#\?]/g,Xu=/[#\?@]/g,Yu=/#/g;function We(s,a){this.h=this.g=null,this.i=s||null,this.j=!!a}function ie(s){s.g||(s.g=new Map,s.h=0,s.i&&Gu(s.i,function(a,c){s.add(decodeURIComponent(a.replace(/\+/g," ")),c)}))}r=We.prototype,r.add=function(s,a){ie(this),this.i=null,s=me(this,s);let c=this.g.get(s);return c||this.g.set(s,c=[]),c.push(a),this.h+=1,this};function Ai(s,a){ie(s),a=me(s,a),s.g.has(a)&&(s.i=null,s.h-=s.g.get(a).length,s.g.delete(a))}function Ri(s,a){return ie(s),a=me(s,a),s.g.has(a)}r.forEach=function(s,a){ie(this),this.g.forEach(function(c,h){c.forEach(function(v){s.call(a,v,h,this)},this)},this)};function Ci(s,a){ie(s);let c=[];if(typeof a=="string")Ri(s,a)&&(c=c.concat(s.g.get(me(s,a))));else for(s=Array.from(s.g.values()),a=0;a<s.length;a++)c=c.concat(s[a]);return c}r.set=function(s,a){return ie(this),this.i=null,s=me(this,s),Ri(this,s)&&(this.h-=this.g.get(s).length),this.g.set(s,[a]),this.h+=1,this},r.get=function(s,a){return s?(s=Ci(this,s),s.length>0?String(s[0]):a):a};function Si(s,a,c){Ai(s,a),c.length>0&&(s.i=null,s.g.set(me(s,a),S(c)),s.h+=c.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const s=[],a=Array.from(this.g.keys());for(let h=0;h<a.length;h++){var c=a[h];const v=$e(c);c=Ci(this,c);for(let A=0;A<c.length;A++){let b=v;c[A]!==""&&(b+="="+$e(c[A])),s.push(b)}}return this.i=s.join("&")};function bi(s){const a=new We;return a.i=s.i,s.g&&(a.g=new Map(s.g),a.h=s.h),a}function me(s,a){return a=String(a),s.j&&(a=a.toLowerCase()),a}function Ju(s,a){a&&!s.j&&(ie(s),s.i=null,s.g.forEach(function(c,h){const v=h.toLowerCase();h!=v&&(Ai(this,h),Si(this,v,c))},s)),s.j=a}function Zu(s,a){const c=new je;if(u.Image){const h=new Image;h.onload=_(Ut,c,"TestLoadImage: loaded",!0,a,h),h.onerror=_(Ut,c,"TestLoadImage: error",!1,a,h),h.onabort=_(Ut,c,"TestLoadImage: abort",!1,a,h),h.ontimeout=_(Ut,c,"TestLoadImage: timeout",!1,a,h),u.setTimeout(function(){h.ontimeout&&h.ontimeout()},1e4),h.src=s}else a(!1)}function tc(s,a){const c=new je,h=new AbortController,v=setTimeout(()=>{h.abort(),Ut(c,"TestPingServer: timeout",!1,a)},1e4);fetch(s,{signal:h.signal}).then(A=>{clearTimeout(v),A.ok?Ut(c,"TestPingServer: ok",!0,a):Ut(c,"TestPingServer: server error",!1,a)}).catch(()=>{clearTimeout(v),Ut(c,"TestPingServer: error",!1,a)})}function Ut(s,a,c,h,v){try{v&&(v.onload=null,v.onerror=null,v.onabort=null,v.ontimeout=null),h(c)}catch{}}function ec(){this.g=new Lu}function Or(s){this.i=s.Sb||null,this.h=s.ab||!1}w(Or,si),Or.prototype.g=function(){return new bn(this.i,this.h)};function bn(s,a){dt.call(this),this.H=s,this.o=a,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}w(bn,dt),r=bn.prototype,r.open=function(s,a){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=s,this.D=a,this.readyState=1,Ye(this)},r.send=function(s){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const a={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};s&&(a.body=s),(this.H||u).fetch(new Request(this.D,a)).then(this.Pa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Xe(this)),this.readyState=0},r.Pa=function(s){if(this.g&&(this.l=s,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=s.headers,this.readyState=2,Ye(this)),this.g&&(this.readyState=3,Ye(this),this.g)))if(this.responseType==="arraybuffer")s.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof u.ReadableStream<"u"&&"body"in s){if(this.j=s.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Pi(this)}else s.text().then(this.Oa.bind(this),this.ga.bind(this))};function Pi(s){s.j.read().then(s.Ma.bind(s)).catch(s.ga.bind(s))}r.Ma=function(s){if(this.g){if(this.o&&s.value)this.response.push(s.value);else if(!this.o){var a=s.value?s.value:new Uint8Array(0);(a=this.B.decode(a,{stream:!s.done}))&&(this.response=this.responseText+=a)}s.done?Xe(this):Ye(this),this.readyState==3&&Pi(this)}},r.Oa=function(s){this.g&&(this.response=this.responseText=s,Xe(this))},r.Na=function(s){this.g&&(this.response=s,Xe(this))},r.ga=function(){this.g&&Xe(this)};function Xe(s){s.readyState=4,s.l=null,s.j=null,s.B=null,Ye(s)}r.setRequestHeader=function(s,a){this.A.append(s,a)},r.getResponseHeader=function(s){return this.h&&this.h.get(s.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const s=[],a=this.h.entries();for(var c=a.next();!c.done;)c=c.value,s.push(c[0]+": "+c[1]),c=a.next();return s.join(`\r
`)};function Ye(s){s.onreadystatechange&&s.onreadystatechange.call(s)}Object.defineProperty(bn.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(s){this.m=s?"include":"same-origin"}});function Vi(s){let a="";return vn(s,function(c,h){a+=h,a+=":",a+=c,a+=`\r
`}),a}function Mr(s,a,c){t:{for(h in c){var h=!1;break t}h=!0}h||(c=Vi(c),typeof s=="string"?c!=null&&$e(c):K(s,a,c))}function J(s){dt.call(this),this.headers=new Map,this.L=s||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}w(J,dt);var nc=/^https?$/i,rc=["POST","PUT"];r=J.prototype,r.Fa=function(s){this.H=s},r.ea=function(s,a,c,h){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+s);a=a?a.toUpperCase():"GET",this.D=s,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():hi.g(),this.g.onreadystatechange=R(f(this.Ca,this));try{this.B=!0,this.g.open(a,String(s),!0),this.B=!1}catch(A){Di(this,A);return}if(s=c||"",c=new Map(this.headers),h)if(Object.getPrototypeOf(h)===Object.prototype)for(var v in h)c.set(v,h[v]);else if(typeof h.keys=="function"&&typeof h.get=="function")for(const A of h.keys())c.set(A,h.get(A));else throw Error("Unknown input type for opt_headers: "+String(h));h=Array.from(c.keys()).find(A=>A.toLowerCase()=="content-type"),v=u.FormData&&s instanceof u.FormData,!(Array.prototype.indexOf.call(rc,a,void 0)>=0)||h||v||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[A,b]of c)this.g.setRequestHeader(A,b);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(s),this.v=!1}catch(A){Di(this,A)}};function Di(s,a){s.h=!1,s.g&&(s.j=!0,s.g.abort(),s.j=!1),s.l=a,s.o=5,Ni(s),Pn(s)}function Ni(s){s.A||(s.A=!0,_t(s,"complete"),_t(s,"error"))}r.abort=function(s){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=s||7,_t(this,"complete"),_t(this,"abort"),Pn(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Pn(this,!0)),J.Z.N.call(this)},r.Ca=function(){this.u||(this.B||this.v||this.j?ki(this):this.Xa())},r.Xa=function(){ki(this)};function ki(s){if(s.h&&typeof o<"u"){if(s.v&&Bt(s)==4)setTimeout(s.Ca.bind(s),0);else if(_t(s,"readystatechange"),Bt(s)==4){s.h=!1;try{const A=s.ca();t:switch(A){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var a=!0;break t;default:a=!1}var c;if(!(c=a)){var h;if(h=A===0){let b=String(s.D).match(Ii)[1]||null;!b&&u.self&&u.self.location&&(b=u.self.location.protocol.slice(0,-1)),h=!nc.test(b?b.toLowerCase():"")}c=h}if(c)_t(s,"complete"),_t(s,"success");else{s.o=6;try{var v=Bt(s)>2?s.g.statusText:""}catch{v=""}s.l=v+" ["+s.ca()+"]",Ni(s)}}finally{Pn(s)}}}}function Pn(s,a){if(s.g){s.m&&(clearTimeout(s.m),s.m=null);const c=s.g;s.g=null,a||_t(s,"ready");try{c.onreadystatechange=null}catch{}}}r.isActive=function(){return!!this.g};function Bt(s){return s.g?s.g.readyState:0}r.ca=function(){try{return Bt(this)>2?this.g.status:-1}catch{return-1}},r.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.La=function(s){if(this.g){var a=this.g.responseText;return s&&a.indexOf(s)==0&&(a=a.substring(s.length)),Mu(a)}};function xi(s){try{if(!s.g)return null;if("response"in s.g)return s.g.response;switch(s.F){case"":case"text":return s.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in s.g)return s.g.mozResponseArrayBuffer}return null}catch{return null}}function sc(s){const a={};s=(s.g&&Bt(s)>=2&&s.g.getAllResponseHeaders()||"").split(`\r
`);for(let h=0;h<s.length;h++){if(m(s[h]))continue;var c=ju(s[h]);const v=c[0];if(c=c[1],typeof c!="string")continue;c=c.trim();const A=a[v]||[];a[v]=A,A.push(c)}Vu(a,function(h){return h.join(", ")})}r.ya=function(){return this.o},r.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Je(s,a,c){return c&&c.internalChannelParams&&c.internalChannelParams[s]||a}function Oi(s){this.za=0,this.i=[],this.j=new je,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Je("failFast",!1,s),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Je("baseRetryDelayMs",5e3,s),this.Za=Je("retryDelaySeedMs",1e4,s),this.Ta=Je("forwardChannelMaxRetries",2,s),this.va=Je("forwardChannelRequestTimeoutMs",2e4,s),this.ma=s&&s.xmlHttpFactory||void 0,this.Ua=s&&s.Rb||void 0,this.Aa=s&&s.useFetchStreams||!1,this.O=void 0,this.L=s&&s.supportsCrossDomainXhr||!1,this.M="",this.h=new _i(s&&s.concurrentRequestLimit),this.Ba=new ec,this.S=s&&s.fastHandshake||!1,this.R=s&&s.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=s&&s.Pb||!1,s&&s.ua&&this.j.ua(),s&&s.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&s&&s.detectBufferingProxy||!1,this.ia=void 0,s&&s.longPollingTimeout&&s.longPollingTimeout>0&&(this.ia=s.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}r=Oi.prototype,r.ka=8,r.I=1,r.connect=function(s,a,c,h){yt(0),this.W=s,this.H=a||{},c&&h!==void 0&&(this.H.OSID=c,this.H.OAID=h),this.F=this.X,this.J=zi(this,null,this.W),Dn(this)};function Lr(s){if(Mi(s),s.I==3){var a=s.V++,c=St(s.J);if(K(c,"SID",s.M),K(c,"RID",a),K(c,"TYPE","terminate"),Ze(s,c),a=new Lt(s,s.j,a),a.M=2,a.A=Sn(St(c)),c=!1,u.navigator&&u.navigator.sendBeacon)try{c=u.navigator.sendBeacon(a.A.toString(),"")}catch{}!c&&u.Image&&(new Image().src=a.A,c=!0),c||(a.g=Hi(a.j,null),a.g.ea(a.A)),a.F=Date.now(),Cn(a)}$i(s)}function Vn(s){s.g&&(Ur(s),s.g.cancel(),s.g=null)}function Mi(s){Vn(s),s.v&&(u.clearTimeout(s.v),s.v=null),Nn(s),s.h.cancel(),s.m&&(typeof s.m=="number"&&u.clearTimeout(s.m),s.m=null)}function Dn(s){if(!yi(s.h)&&!s.m){s.m=!0;var a=s.Ea;Tt||p(),at||(Tt(),at=!0),E.add(a,s),s.D=0}}function ic(s,a){return Ei(s.h)>=s.h.j-(s.m?1:0)?!1:s.m?(s.i=a.G.concat(s.i),!0):s.I==1||s.I==2||s.D>=(s.Sa?0:s.Ta)?!1:(s.m=qe(f(s.Ea,s,a),ji(s,s.D)),s.D++,!0)}r.Ea=function(s){if(this.m)if(this.m=null,this.I==1){if(!s){this.V=Math.floor(Math.random()*1e5),s=this.V++;const v=new Lt(this,this.j,s);let A=this.o;if(this.U&&(A?(A=Qs(A),Xs(A,this.U)):A=this.U),this.u!==null||this.R||(v.J=A,A=null),this.S)t:{for(var a=0,c=0;c<this.i.length;c++){e:{var h=this.i[c];if("__data__"in h.map&&(h=h.map.__data__,typeof h=="string")){h=h.length;break e}h=void 0}if(h===void 0)break;if(a+=h,a>4096){a=c;break t}if(a===4096||c===this.i.length-1){a=c+1;break t}}a=1e3}else a=1e3;a=Fi(this,v,a),c=St(this.J),K(c,"RID",s),K(c,"CVER",22),this.G&&K(c,"X-HTTP-Session-Id",this.G),Ze(this,c),A&&(this.R?a="headers="+$e(Vi(A))+"&"+a:this.u&&Mr(c,this.u,A)),kr(this.h,v),this.Ra&&K(c,"TYPE","init"),this.S?(K(c,"$req",a),K(c,"SID","null"),v.U=!0,Pr(v,c,null)):Pr(v,c,a),this.I=2}}else this.I==3&&(s?Li(this,s):this.i.length==0||yi(this.h)||Li(this))};function Li(s,a){var c;a?c=a.l:c=s.V++;const h=St(s.J);K(h,"SID",s.M),K(h,"RID",c),K(h,"AID",s.K),Ze(s,h),s.u&&s.o&&Mr(h,s.u,s.o),c=new Lt(s,s.j,c,s.D+1),s.u===null&&(c.J=s.o),a&&(s.i=a.G.concat(s.i)),a=Fi(s,c,1e3),c.H=Math.round(s.va*.5)+Math.round(s.va*.5*Math.random()),kr(s.h,c),Pr(c,h,a)}function Ze(s,a){s.H&&vn(s.H,function(c,h){K(a,h,c)}),s.l&&vn({},function(c,h){K(a,h,c)})}function Fi(s,a,c){c=Math.min(s.i.length,c);const h=s.l?f(s.l.Ka,s.l,s):null;t:{var v=s.i;let F=-1;for(;;){const st=["count="+c];F==-1?c>0?(F=v[0].g,st.push("ofs="+F)):F=0:st.push("ofs="+F);let z=!0;for(let ut=0;ut<c;ut++){var A=v[ut].g;const bt=v[ut].map;if(A-=F,A<0)F=Math.max(0,v[ut].g-100),z=!1;else try{A="req"+A+"_"||"";try{var b=bt instanceof Map?bt:Object.entries(bt);for(const[ae,qt]of b){let jt=qt;l(qt)&&(jt=Ar(qt)),st.push(A+ae+"="+encodeURIComponent(jt))}}catch(ae){throw st.push(A+"type="+encodeURIComponent("_badmap")),ae}}catch{h&&h(bt)}}if(z){b=st.join("&");break t}}b=void 0}return s=s.i.splice(0,c),a.G=s,b}function Ui(s){if(!s.g&&!s.v){s.Y=1;var a=s.Da;Tt||p(),at||(Tt(),at=!0),E.add(a,s),s.A=0}}function Fr(s){return s.g||s.v||s.A>=3?!1:(s.Y++,s.v=qe(f(s.Da,s),ji(s,s.A)),s.A++,!0)}r.Da=function(){if(this.v=null,Bi(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var s=4*this.T;this.j.info("BP detection timer enabled: "+s),this.B=qe(f(this.Wa,this),s)}},r.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,yt(10),Vn(this),Bi(this))};function Ur(s){s.B!=null&&(u.clearTimeout(s.B),s.B=null)}function Bi(s){s.g=new Lt(s,s.j,"rpc",s.Y),s.u===null&&(s.g.J=s.o),s.g.P=0;var a=St(s.na);K(a,"RID","rpc"),K(a,"SID",s.M),K(a,"AID",s.K),K(a,"CI",s.F?"0":"1"),!s.F&&s.ia&&K(a,"TO",s.ia),K(a,"TYPE","xmlhttp"),Ze(s,a),s.u&&s.o&&Mr(a,s.u,s.o),s.O&&(s.g.H=s.O);var c=s.g;s=s.ba,c.M=1,c.A=Sn(St(a)),c.u=null,c.R=!0,pi(c,s)}r.Va=function(){this.C!=null&&(this.C=null,Vn(this),Fr(this),yt(19))};function Nn(s){s.C!=null&&(u.clearTimeout(s.C),s.C=null)}function qi(s,a){var c=null;if(s.g==a){Nn(s),Ur(s),s.g=null;var h=2}else if(Nr(s.h,a))c=a.G,Ti(s.h,a),h=1;else return;if(s.I!=0){if(a.o)if(h==1){c=a.u?a.u.length:0,a=Date.now()-a.F;var v=s.D;h=An(),_t(h,new ci(h,c)),Dn(s)}else Ui(s);else if(v=a.m,v==3||v==0&&a.X>0||!(h==1&&ic(s,a)||h==2&&Fr(s)))switch(c&&c.length>0&&(a=s.h,a.i=a.i.concat(c)),v){case 1:oe(s,5);break;case 4:oe(s,10);break;case 3:oe(s,6);break;default:oe(s,2)}}}function ji(s,a){let c=s.Qa+Math.floor(Math.random()*s.Za);return s.isActive()||(c*=2),c*a}function oe(s,a){if(s.j.info("Error code "+a),a==2){var c=f(s.bb,s),h=s.Ua;const v=!h;h=new Ft(h||"//www.google.com/images/cleardot.gif"),u.location&&u.location.protocol=="http"||He(h,"https"),Sn(h),v?Zu(h.toString(),c):tc(h.toString(),c)}else yt(2);s.I=0,s.l&&s.l.pa(a),$i(s),Mi(s)}r.bb=function(s){s?(this.j.info("Successfully pinged google.com"),yt(2)):(this.j.info("Failed to ping google.com"),yt(1))};function $i(s){if(s.I=0,s.ja=[],s.l){const a=vi(s.h);(a.length!=0||s.i.length!=0)&&(x(s.ja,a),x(s.ja,s.i),s.h.i.length=0,S(s.i),s.i.length=0),s.l.oa()}}function zi(s,a,c){var h=c instanceof Ft?St(c):new Ft(c);if(h.g!="")a&&(h.g=a+"."+h.g),Ge(h,h.u);else{var v=u.location;h=v.protocol,a=a?a+"."+v.hostname:v.hostname,v=+v.port;const A=new Ft(null);h&&He(A,h),a&&(A.g=a),v&&Ge(A,v),c&&(A.h=c),h=A}return c=s.G,a=s.wa,c&&a&&K(h,c,a),K(h,"VER",s.ka),Ze(s,h),h}function Hi(s,a,c){if(a&&!s.L)throw Error("Can't create secondary domain capable XhrIo object.");return a=s.Aa&&!s.ma?new J(new Or({ab:c})):new J(s.ma),a.Fa(s.L),a}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function Gi(){}r=Gi.prototype,r.ra=function(){},r.qa=function(){},r.pa=function(){},r.oa=function(){},r.isActive=function(){return!0},r.Ka=function(){};function kn(){}kn.prototype.g=function(s,a){return new wt(s,a)};function wt(s,a){dt.call(this),this.g=new Oi(a),this.l=s,this.h=a&&a.messageUrlParams||null,s=a&&a.messageHeaders||null,a&&a.clientProtocolHeaderRequired&&(s?s["X-Client-Protocol"]="webchannel":s={"X-Client-Protocol":"webchannel"}),this.g.o=s,s=a&&a.initMessageHeaders||null,a&&a.messageContentType&&(s?s["X-WebChannel-Content-Type"]=a.messageContentType:s={"X-WebChannel-Content-Type":a.messageContentType}),a&&a.sa&&(s?s["X-WebChannel-Client-Profile"]=a.sa:s={"X-WebChannel-Client-Profile":a.sa}),this.g.U=s,(s=a&&a.Qb)&&!m(s)&&(this.g.u=s),this.A=a&&a.supportsCrossDomainXhr||!1,this.v=a&&a.sendRawJson||!1,(a=a&&a.httpSessionIdParam)&&!m(a)&&(this.g.G=a,s=this.h,s!==null&&a in s&&(s=this.h,a in s&&delete s[a])),this.j=new ge(this)}w(wt,dt),wt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},wt.prototype.close=function(){Lr(this.g)},wt.prototype.o=function(s){var a=this.g;if(typeof s=="string"){var c={};c.__data__=s,s=c}else this.v&&(c={},c.__data__=Ar(s),s=c);a.i.push(new Hu(a.Ya++,s)),a.I==3&&Dn(a)},wt.prototype.N=function(){this.g.l=null,delete this.j,Lr(this.g),delete this.g,wt.Z.N.call(this)};function Ki(s){Rr.call(this),s.__headers__&&(this.headers=s.__headers__,this.statusCode=s.__status__,delete s.__headers__,delete s.__status__);var a=s.__sm__;if(a){t:{for(const c in a){s=c;break t}s=void 0}(this.i=s)&&(s=this.i,a=a!==null&&s in a?a[s]:void 0),this.data=a}else this.data=s}w(Ki,Rr);function Qi(){Cr.call(this),this.status=1}w(Qi,Cr);function ge(s){this.g=s}w(ge,Gi),ge.prototype.ra=function(){_t(this.g,"a")},ge.prototype.qa=function(s){_t(this.g,new Ki(s))},ge.prototype.pa=function(s){_t(this.g,new Qi)},ge.prototype.oa=function(){_t(this.g,"b")},kn.prototype.createWebChannel=kn.prototype.g,wt.prototype.send=wt.prototype.o,wt.prototype.open=wt.prototype.m,wt.prototype.close=wt.prototype.close,Ia=function(){return new kn},va=function(){return An()},Ta=re,ns={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Rn.NO_ERROR=0,Rn.TIMEOUT=8,Rn.HTTP_ERROR=6,$n=Rn,li.COMPLETE="complete",Ea=li,ii.EventType=Ue,Ue.OPEN="a",Ue.CLOSE="b",Ue.ERROR="c",Ue.MESSAGE="d",dt.prototype.listen=dt.prototype.J,tn=ii,J.prototype.listenOnce=J.prototype.K,J.prototype.getLastError=J.prototype.Ha,J.prototype.getLastErrorCode=J.prototype.ya,J.prototype.getStatus=J.prototype.ca,J.prototype.getResponseJson=J.prototype.La,J.prototype.getResponseText=J.prototype.la,J.prototype.send=J.prototype.ea,J.prototype.setWithCredentials=J.prototype.Fa,ya=J}).apply(typeof On<"u"?On:typeof self<"u"?self:typeof window<"u"?window:{});const ao="@firebase/firestore",uo="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rt(r,t){const e={typeString:r};return t&&(e.value=t),e}function mn(r,t){if(!rh(r))throw new N(P.INVALID_ARGUMENT,"JSON must be an object");let e;for(const n in t)if(t[n]){const i=t[n].typeString,o="value"in t[n]?{value:t[n].value}:void 0;if(!(n in r)){e=`JSON missing required field: '${n}'`;break}const u=r[n];if(i&&typeof u!==i){e=`JSON field '${n}' must be a ${i}.`;break}if(o!==void 0&&u!==o.value){e=`Expected '${n}' field to equal '${o.value}'`;break}}if(e)throw new N(P.INVALID_ARGUMENT,e);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ir(r){if(r.code!==P.FAILED_PRECONDITION||r.message!==uh)throw r;V("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ca="";function dh(r){let t="";for(let e=0;e<r.length;e++)t.length>0&&(t=mo(t)),t=fh(r.get(e),t);return mo(t)}function fh(r,t){let e=t;const n=r.length;for(let i=0;i<n;i++){const o=r.charAt(i);switch(o){case"\0":e+="";break;case Ca:e+="";break;default:e+=o}}return e}function mo(r){return r+Ca+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function go(r){let t=0;for(const e in r)Object.prototype.hasOwnProperty.call(r,e)&&t++;return t}function gn(r,t){for(const e in r)Object.prototype.hasOwnProperty.call(r,e)&&t(e,r[e])}function ph(r){for(const t in r)if(Object.prototype.hasOwnProperty.call(r,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot{constructor(t){this.comparator=t,this.data=new tt(this.comparator)}has(t){return this.data.get(t)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal(((e,n)=>(t(e),!1)))}forEachInRange(t,e){const n=this.data.getIteratorFrom(t[0]);for(;n.hasNext();){const i=n.getNext();if(this.comparator(i.key,t[1])>=0)return;e(i.key)}}forEachWhile(t,e){let n;for(n=e!==void 0?this.data.getIteratorFrom(e):this.data.getIterator();n.hasNext();)if(!t(n.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new _o(this.data.getIterator())}getIteratorFrom(t){return new _o(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach((n=>{e=e.add(n)})),e}isEqual(t){if(!(t instanceof ot)||this.size!==t.size)return!1;const e=this.data.getIterator(),n=t.data.getIterator();for(;e.hasNext();){const i=e.getNext().key,o=n.getNext().key;if(this.comparator(i,o)!==0)return!1}return!0}toArray(){const t=[];return this.forEach((e=>{t.push(e)})),t}toString(){const t=[];return this.forEach((e=>t.push(e))),"SortedSet("+t.toString()+")"}copy(t){const e=new ot(this.comparator);return e.data=t,e}}class _o{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht{constructor(t){this.binaryString=t}static fromBase64String(t){const e=(function(i){try{return atob(i)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new Sa("Invalid base64 string: "+o):o}})(t);return new ht(e)}static fromUint8Array(t){const e=(function(i){let o="";for(let u=0;u<i.length;++u)o+=String.fromCharCode(i[u]);return o})(t);return new ht(e)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(e){return btoa(e)})(this.binaryString)}toUint8Array(){return(function(e){const n=new Uint8Array(e.length);for(let i=0;i<e.length;i++)n[i]=e.charCodeAt(i);return n})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return U(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}ht.EMPTY_BYTE_STRING=new ht("");const mh=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Yt(r){if(Y(!!r,39018),typeof r=="string"){let t=0;const e=mh.exec(r);if(Y(!!e,46558,{timestamp:r}),e[1]){let i=e[1];i=(i+"000000000").substr(0,9),t=Number(i)}const n=new Date(r);return{seconds:Math.floor(n.getTime()/1e3),nanos:t}}return{seconds:Z(r.seconds),nanos:Z(r.nanos)}}function Z(r){return typeof r=="number"?r:typeof r=="string"?Number(r):0}function Jt(r){return typeof r=="string"?ht.fromBase64String(r):ht.fromUint8Array(r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ba="server_timestamp",Pa="__type__",Va="__previous_value__",Da="__local_write_time__";function Cs(r){return(r?.mapValue?.fields||{})[Pa]?.stringValue===ba}function ur(r){const t=r.mapValue.fields[Va];return Cs(t)?ur(t):t}function dn(r){const t=Yt(r.mapValue.fields[Da].timestampValue);return new nt(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Td{constructor(){this.Cn=new vd}addToCollectionParentIndex(t,e){return this.Cn.add(e),C.resolve()}getCollectionParents(t,e){return C.resolve(this.Cn.getEntries(e))}addFieldIndex(t,e){return C.resolve()}deleteFieldIndex(t,e){return C.resolve()}deleteAllFieldIndexes(t){return C.resolve()}createTargetIndexes(t,e){return C.resolve()}getDocumentsMatchingTarget(t,e){return C.resolve(null)}getIndexType(t,e){return C.resolve(0)}getFieldIndexes(t,e){return C.resolve([])}getNextCollectionGroupToUpdate(t){return C.resolve(null)}getMinOffset(t,e){return C.resolve(Xt.min())}getMinOffsetFromCollectionGroup(t,e){return C.resolve(Xt.min())}updateCollectionGroup(t,e,n){return C.resolve()}updateIndexEntries(t,e){return C.resolve()}}class vd{constructor(){this.index={}}add(t){const e=t.lastSegment(),n=t.popLast(),i=this.index[e]||new ot(W.comparator),o=!i.has(n);return this.index[e]=i.add(n),o}has(t){const e=t.lastSegment(),n=t.popLast(),i=this.index[e];return i&&i.has(n)}getEntries(t){return(this.index[t]||new ot(W.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oo={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},ru=41943040;class It{static withCacheSize(t){return new It(t,It.DEFAULT_COLLECTION_PERCENTILE,It.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(t,e,n){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=e,this.maximumSequenceNumbersToCollect=n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sd{constructor(){this.changes=new fe((t=>t.toString()),((t,e)=>t.isEqual(e))),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,mt.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return n!==void 0?C.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nd{constructor(){this.sessionToken=ht.EMPTY_BYTE_STRING}getSessionToken(t){return C.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,C.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft="WebChannelConnection";class Jd extends Xd{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,n,i,o){const u=_s();return new Promise(((l,d)=>{const f=new ya;f.setWithCredentials(!0),f.listenOnce(Ea.COMPLETE,(()=>{try{switch(f.getLastErrorCode()){case $n.NO_ERROR:const w=f.getResponseJson();V(ft,`XHR for RPC '${t}' ${u} received:`,JSON.stringify(w)),l(w);break;case $n.TIMEOUT:V(ft,`RPC '${t}' ${u} timed out`),d(new N(P.DEADLINE_EXCEEDED,"Request time out"));break;case $n.HTTP_ERROR:const R=f.getStatus();if(V(ft,`RPC '${t}' ${u} failed with status:`,R,"response text:",f.getResponseText()),R>0){let S=f.getResponseJson();Array.isArray(S)&&(S=S[0]);const x=S?.error;if(x&&x.status&&x.message){const L=(function(Q){const G=Q.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(G)>=0?G:P.UNKNOWN})(x.status);d(new N(L,x.message))}else d(new N(P.UNKNOWN,"Server responded with status "+f.getStatus()))}else d(new N(P.UNAVAILABLE,"Connection failed."));break;default:M(9055,{l_:t,streamId:u,h_:f.getLastErrorCode(),P_:f.getLastError()})}}finally{V(ft,`RPC '${t}' ${u} completed.`)}}));const _=JSON.stringify(i);V(ft,`RPC '${t}' ${u} sending request:`,i),f.send(e,"POST",_,n,15)}))}T_(t,e,n){const i=_s(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],u=Ia(),l=va(),d={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(d.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(d.useFetchStreams=!0),this.jo(d.initMessageHeaders,e,n),d.encodeInitMessageHeaders=!0;const _=o.join("");V(ft,`Creating RPC '${t}' stream ${i}: ${_}`,d);const w=u.createWebChannel(_,d);this.I_(w);let R=!1,S=!1;const x=new Yd({Yo:D=>{S?V(ft,`Not sending because RPC '${t}' stream ${i} is closed:`,D):(R||(V(ft,`Opening RPC '${t}' stream ${i} transport.`),w.open(),R=!0),V(ft,`RPC '${t}' stream ${i} sending:`,D),w.send(D))},Zo:()=>w.close()}),L=(D,Q,G)=>{D.listen(Q,(H=>{try{G(H)}catch(gt){setTimeout((()=>{throw gt}),0)}}))};return L(w,tn.EventType.OPEN,(()=>{S||(V(ft,`RPC '${t}' stream ${i} transport opened.`),x.o_())})),L(w,tn.EventType.CLOSE,(()=>{S||(S=!0,V(ft,`RPC '${t}' stream ${i} transport closed`),x.a_(),this.E_(w))})),L(w,tn.EventType.ERROR,(D=>{S||(S=!0,Se(ft,`RPC '${t}' stream ${i} transport errored. Name:`,D.name,"Message:",D.message),x.a_(new N(P.UNAVAILABLE,"The operation could not be completed")))})),L(w,tn.EventType.MESSAGE,(D=>{if(!S){const Q=D.data[0];Y(!!Q,16349);const G=Q,H=G?.error||G[0]?.error;if(H){V(ft,`RPC '${t}' stream ${i} received error:`,H);const gt=H.status;let Tt=(function(p){const g=et[p];if(g!==void 0)return Qa(g)})(gt),at=H.message;Tt===void 0&&(Tt=P.INTERNAL,at="Unknown error status: "+gt+" with message "+H.message),S=!0,x.a_(new N(Tt,at)),w.close()}else V(ft,`RPC '${t}' stream ${i} received:`,Q),x.u_(Q)}})),L(l,Ta.STAT_EVENT,(D=>{D.stat===ns.PROXY?V(ft,`RPC '${t}' stream ${i} detected buffering proxy`):D.stat===ns.NOPROXY&&V(ft,`RPC '${t}' stream ${i} detected no buffering proxy`)})),setTimeout((()=>{x.__()}),0),x}terminate(){this.c_.forEach((t=>t.close())),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter((e=>e===t))}}function Wr(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ef{}class nf extends ef{constructor(t,e,n,i){super(),this.authCredentials=t,this.appCheckCredentials=e,this.connection=n,this.serializer=i,this.ia=!1}sa(){if(this.ia)throw new N(P.FAILED_PRECONDITION,"The client has already been terminated.")}Go(t,e,n,i){return this.sa(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([o,u])=>this.connection.Go(t,ms(e,n),i,o,u))).catch((o=>{throw o.name==="FirebaseError"?(o.code===P.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new N(P.UNKNOWN,o.toString())}))}Ho(t,e,n,i,o){return this.sa(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([u,l])=>this.connection.Ho(t,ms(e,n),i,u,l,o))).catch((u=>{throw u.name==="FirebaseError"?(u.code===P.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),u):new N(P.UNKNOWN,u.toString())}))}terminate(){this.ia=!0,this.connection.terminate()}}class rf{constructor(t,e){this.asyncQueue=t,this.onlineStateHandler=e,this.state="Unknown",this.oa=0,this._a=null,this.aa=!0}ua(){this.oa===0&&(this.ca("Unknown"),this._a=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(()=>(this._a=null,this.la("Backend didn't respond within 10 seconds."),this.ca("Offline"),Promise.resolve()))))}ha(t){this.state==="Online"?this.ca("Unknown"):(this.oa++,this.oa>=1&&(this.Pa(),this.la(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.ca("Offline")))}set(t){this.Pa(),this.oa=0,t==="Online"&&(this.aa=!1),this.ca(t)}ca(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}la(t){const e=`Could not reach Cloud Firestore backend. ${t}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ne="RemoteStore";class sf{constructor(t,e,n,i,o){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=o,this.Aa.Oo((u=>{n.enqueueAndForget((async()=>{En(this)&&(V(Ne,"Restarting streams for network reachability change."),await(async function(d){const f=j(d);f.Ea.add(4),await yn(f),f.Ra.set("Unknown"),f.Ea.delete(4),await mr(f)})(this))}))})),this.Ra=new rf(n,i)}}async function mr(r){if(En(r))for(const t of r.da)await t(!0)}async function yn(r){for(const t of r.da)await t(!1)}function cu(r,t){const e=j(r);e.Ia.has(t.targetId)||(e.Ia.set(t.targetId,t),Bs(e)?Us(e):Le(e).O_()&&Fs(e,t))}function Ls(r,t){const e=j(r),n=Le(e);e.Ia.delete(t),n.O_()&&lu(e,t),e.Ia.size===0&&(n.O_()?n.L_():En(e)&&e.Ra.set("Unknown"))}function Fs(r,t){if(r.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(O.min())>0){const e=r.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}Le(r).Y_(t)}function lu(r,t){r.Va.Ue(t),Le(r).Z_(t)}function Us(r){r.Va=new ed({getRemoteKeysForTarget:t=>r.remoteSyncer.getRemoteKeysForTarget(t),At:t=>r.Ia.get(t)||null,ht:()=>r.datastore.serializer.databaseId}),Le(r).start(),r.Ra.ua()}function Bs(r){return En(r)&&!Le(r).x_()&&r.Ia.size>0}function En(r){return j(r).Ea.size===0}function hu(r){r.Va=void 0}async function of(r){r.Ra.set("Online")}async function af(r){r.Ia.forEach(((t,e)=>{Fs(r,t)}))}async function uf(r,t){hu(r),Bs(r)?(r.Ra.ha(t),Us(r)):r.Ra.set("Unknown")}async function cf(r,t,e){if(r.Ra.set("Online"),t instanceof Xa&&t.state===2&&t.cause)try{await(async function(i,o){const u=o.cause;for(const l of o.targetIds)i.Ia.has(l)&&(await i.remoteSyncer.rejectListen(l,u),i.Ia.delete(l),i.Va.removeTarget(l))})(r,t)}catch(n){V(Ne,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await $o(r,n)}else if(t instanceof Gn?r.Va.Ze(t):t instanceof Wa?r.Va.st(t):r.Va.tt(t),!e.isEqual(O.min()))try{const n=await ou(r.localStore);e.compareTo(n)>=0&&await(function(o,u){const l=o.Va.Tt(u);return l.targetChanges.forEach(((d,f)=>{if(d.resumeToken.approximateByteSize()>0){const _=o.Ia.get(f);_&&o.Ia.set(f,_.withResumeToken(d.resumeToken,u))}})),l.targetMismatches.forEach(((d,f)=>{const _=o.Ia.get(d);if(!_)return;o.Ia.set(d,_.withResumeToken(ht.EMPTY_BYTE_STRING,_.snapshotVersion)),lu(o,d);const w=new zt(_.target,d,f,_.sequenceNumber);Fs(o,w)})),o.remoteSyncer.applyRemoteEvent(l)})(r,e)}catch(n){V(Ne,"Failed to raise snapshot:",n),await $o(r,n)}}async function $o(r,t,e){if(!Me(t))throw t;r.Ea.add(1),await yn(r),r.Ra.set("Offline"),e||(e=()=>ou(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{V(Ne,"Retrying IndexedDB access"),await e(),r.Ea.delete(1),await mr(r)}))}async function zo(r,t){const e=j(r);e.asyncQueue.verifyOperationInProgress(),V(Ne,"RemoteStore received new credentials");const n=En(e);e.Ea.add(3),await yn(e),n&&e.Ra.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ea.delete(3),await mr(e)}async function lf(r,t){const e=j(r);t?(e.Ea.delete(2),await mr(e)):t||(e.Ea.add(2),await yn(e),e.Ra.set("Unknown"))}function Le(r){return r.ma||(r.ma=(function(e,n,i){const o=j(e);return o.sa(),new tf(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)})(r.datastore,r.asyncQueue,{Xo:of.bind(null,r),t_:af.bind(null,r),r_:uf.bind(null,r),H_:cf.bind(null,r)}),r.da.push((async t=>{t?(r.ma.B_(),Bs(r)?Us(r):r.Ra.set("Unknown")):(await r.ma.stop(),hu(r))}))),r.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dt{constructor(t){this._byteString=t}static fromBase64String(t){try{return new Dt(ht.fromBase64String(t))}catch(e){throw new N(P.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new Dt(ht.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}toJSON(){return{type:Dt._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(t){if(mn(t,Dt._jsonSchema))return Dt.fromBase64String(t.bytes)}}Dt._jsonSchemaVersion="firestore/bytes/1.0",Dt._jsonSchema={type:rt("string",Dt._jsonSchemaVersion),bytes:rt("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wu{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new N(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Et(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new N(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new N(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return U(this._lat,t._lat)||U(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Qt._jsonSchemaVersion}}static fromJSON(t){if(mn(t,Qt._jsonSchema))return new Qt(t.latitude,t.longitude)}}Qt._jsonSchemaVersion="firestore/geoPoint/1.0",Qt._jsonSchema={type:rt("string",Qt._jsonSchemaVersion),latitude:rt("number"),longitude:rt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{constructor(t){this._values=(t||[]).map((e=>e))}toArray(){return this._values.map((t=>t))}isEqual(t){return(function(n,i){if(n.length!==i.length)return!1;for(let o=0;o<n.length;++o)if(n[o]!==i[o])return!1;return!0})(this._values,t._values)}toJSON(){return{type:Wt._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(t){if(mn(t,Wt._jsonSchema)){if(Array.isArray(t.vectorValues)&&t.vectorValues.every((e=>typeof e=="number")))return new Wt(t.vectorValues);throw new N(P.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Wt._jsonSchemaVersion="firestore/vectorValue/1.0",Wt._jsonSchema={type:rt("string",Wt._jsonSchemaVersion),vectorValues:rt("object")};const $f=new RegExp("[~\\*/\\[\\]]");function zf(r,t,e){if(t.search($f)>=0)throw ra(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,r);try{return new wu(...t.split("."))._internalPath}catch{throw ra(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,r)}}function ra(r,t,e,n,i){let o=`Function ${t}() called with invalid data`;o+=". ";let u="";return new N(P.INVALID_ARGUMENT,o+r+u)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gf(r){if(r.limitType==="L"&&r.explicitOrderBy.length===0)throw new N(P.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Kf{convertValue(t,e="none"){switch(Zt(t)){case 0:return null;case 1:return t.booleanValue;case 2:return Z(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(Jt(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw M(62114,{value:t})}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const n={};return gn(t,((i,o)=>{n[i]=this.convertValue(o,e)})),n}convertVectorValue(t){const e=t.fields?.[os].arrayValue?.values?.map((n=>Z(n.doubleValue)));return new Wt(e)}convertGeoPoint(t){return new Qt(Z(t.latitude),Z(t.longitude))}convertArray(t,e){return(t.values||[]).map((n=>this.convertValue(n,e)))}convertServerTimestamp(t,e){switch(e){case"previous":const n=ur(t);return n==null?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(dn(t));default:return null}}convertTimestamp(t){const e=Yt(t);return new nt(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=W.fromString(t);Y(nu(n),9688,{name:t});const i=new fn(n.get(1),n.get(3)),o=new k(n.popFirst(5));return i.isEqual(e)||Mt(`Document ${o} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),o}}class Bn{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Re extends Au{constructor(t,e,n,i,o,u){super(t,e,n,i,u),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new Kn(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Ru("DocumentSnapshot.get",t));if(n!==null)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new N(P.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t=this._document,e={};return e.type=Re._jsonSchemaVersion,e.bundle="",e.bundleSource="DocumentSnapshot",e.bundleName=this._key.toString(),!t||!t.isValidDocument()||!t.isFoundDocument()?e:(this._userDataWriter.convertObjectMap(t.data.value.mapValue.fields,"previous"),e.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),e)}}Re._jsonSchemaVersion="firestore/documentSnapshot/1.0",Re._jsonSchema={type:rt("string",Re._jsonSchemaVersion),bundleSource:rt("string","DocumentSnapshot"),bundleName:rt("string"),bundle:rt("string")};class Kn extends Re{data(t={}){return super.data(t)}}class Ce{constructor(t,e,n,i){this._firestore=t,this._userDataWriter=e,this._snapshot=i,this.metadata=new Bn(i.hasPendingWrites,i.fromCache),this.query=n}get docs(){const t=[];return this.forEach((e=>t.push(e))),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach((n=>{t.call(e,new Kn(this._firestore,this._userDataWriter,n.key,n,new Bn(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new N(P.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=(function(i,o){if(i._snapshot.oldDocs.isEmpty()){let u=0;return i._snapshot.docChanges.map((l=>{const d=new Kn(i._firestore,i._userDataWriter,l.doc.key,l.doc,new Bn(i._snapshot.mutatedKeys.has(l.doc.key),i._snapshot.fromCache),i.query.converter);return l.doc,{type:"added",doc:d,oldIndex:-1,newIndex:u++}}))}{let u=i._snapshot.oldDocs;return i._snapshot.docChanges.filter((l=>o||l.type!==3)).map((l=>{const d=new Kn(i._firestore,i._userDataWriter,l.doc.key,l.doc,new Bn(i._snapshot.mutatedKeys.has(l.doc.key),i._snapshot.fromCache),i.query.converter);let f=-1,_=-1;return l.type!==0&&(f=u.indexOf(l.doc.key),u=u.delete(l.doc.key)),l.type!==1&&(u=u.add(l.doc),_=u.indexOf(l.doc.key)),{type:Qf(l.type),doc:d,oldIndex:f,newIndex:_}}))}})(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new N(P.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t={};t.type=Ce._jsonSchemaVersion,t.bundleSource="QuerySnapshot",t.bundleName=Ra.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const e=[],n=[],i=[];return this.docs.forEach((o=>{o._document!==null&&(e.push(o._document),n.push(this._userDataWriter.convertObjectMap(o._document.data.value.mapValue.fields,"previous")),i.push(o.ref.path))})),t.bundle=(this._firestore,this.query._query,t.bundleName,"NOT SUPPORTED"),t}}function Qf(r){switch(r){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return M(61501,{type:r})}}Ce._jsonSchemaVersion="firestore/querySnapshot/1.0",Ce._jsonSchema={type:rt("string",Ce._jsonSchemaVersion),bundleSource:rt("string","QuerySnapshot"),bundleName:rt("string"),bundle:rt("string")};class Wf extends Kf{constructor(t){super(),this.firestore=t}convertBytes(t){return new Dt(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Rt(this.firestore,null,e)}}function Xf(r){r=ss(r,gr);const t=ss(r.firestore,Iu),e=qf(t),n=new Wf(t);return Gf(r._query),Lf(e,r._query).then((i=>new Ce(t,n,r,i)))}(function(t,e=!0){(function(i){Oe=i})(Nl),Yn(new cn("firestore",((n,{instanceIdentifier:i,options:o})=>{const u=n.getProvider("app").getImmediate(),l=new Iu(new Ql(n.getProvider("auth-internal")),new Yl(u,n.getProvider("app-check-internal")),(function(f,_){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new N(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new fn(f.options.projectId,_)})(u,i),u);return o={useFetchStreams:e,...o},l._setSettings(o),l}),"PUBLIC").setMultipleInstances(!0)),ve(ao,uo,t),ve(ao,uo,"esm2020")})();const Yf={apiKey:"AIzaSyBtnkqK0cq137PH_mJdaBeK55MPSHAXQ34",authDomain:"chiligums-map.firebaseapp.com",projectId:"chiligums-map",storageBucket:"chiligums-map.appspot.com",messagingSenderId:"207156196903",appId:"1:207156196903:web:546c8a59be8f7eac360002",measurementId:"G-3LVL8XNYBW"},Jf=pa(Yf),Zf=Bf(Jf);mapboxgl.accessToken="pk.eyJ1IjoiYW5kcm8xMTUwIiwiYSI6ImNtZzQ4YjVudjByanUybnFiNXg4dHB4bmoifQ._SZZ_tvydofhnFu1FO_mAA";const Gs=[-78.1474059,.0429804],At=new mapboxgl.Map({container:"map",style:"mapbox://styles/mapbox/streets-v12",center:Gs,zoom:14});At.addControl(new mapboxgl.NavigationControl);function sa(){document.getElementById("mapLoader").style.display="flex"}function ia(){document.getElementById("mapLoader").style.display="none"}class tp{onAdd(t){this._map=t,this._btn=document.createElement("button"),this._btn.className="mapboxgl-ctrl-icon",this._btn.type="button",this._btn.title="Centrar en Cayambe",this._btn.textContent="🎯",this._btn.onclick=()=>{t.flyTo({center:Gs,zoom:14,speed:1.2})};const e=document.createElement("div");return e.className="mapboxgl-ctrl-group mapboxgl-ctrl",e.appendChild(this._btn),e}onRemove(){this._btn.parentNode.removeChild(this._btn),this._map=void 0}}At.addControl(new tp,"top-right");const X=document.createElement("div");X.id="customPopup";X.style.position="absolute";X.style.transform="translate(-50%, -140%)";X.style.display="none";X.style.zIndex="999";At.getContainer().appendChild(X);let vs=[],Ct=null;function Ks(){return/iPad|iPhone|iPod/.test(navigator.userAgent)||navigator.platform==="MacIntel"&&navigator.maxTouchPoints>1}function ep(r,t){const e=encodeURIComponent(`${r},${t}`);return Ks()?`maps://?daddr=${e}&dirflg=d`:`https://www.google.com/maps/dir/?api=1&destination=${e}&travelmode=driving`}function np(r,t,e){if(!r||Ks())return r;{const n=encodeURIComponent(`${t},${e}`);return`${r}&origin=${n}`}}async function Cu(){(await Xf(Uf(Zf,"puntos_venta"))).forEach(t=>{const e=t.data(),n=[e.lng,e.lat],i=new mapboxgl.Marker({color:"orange"}).setLngLat(n).addTo(At);vs.push(i),i.getElement().addEventListener("click",async()=>{let o=ep(e.lat,e.lng);const u=document.querySelector("#pickupTemplate .popup-card").cloneNode(!0);u.querySelector(".popup-title").textContent=e.nombre??"Punto de venta",u.querySelector(".popup-desc").textContent=e.direccion??"",u.querySelector(".popup-btn").textContent="🧭 Cómo llegar";const l=u.querySelector(".popup-btn");l.dataset.href=o,l.addEventListener("click",_=>{_.preventDefault();const w=l.dataset.href||o;console.log("Abriendo ruta (href):",w),window.location.href=w});const d=u.querySelector(".popup-close");d&&d.addEventListener("click",()=>{X.style.display="none"}),X.innerHTML="",X.appendChild(u);const f=At.project(n);X.style.left=f.x+"px",X.style.top=f.y+"px",X.style.display="block",navigator.geolocation&&navigator.geolocation.getCurrentPosition(_=>{const w=_.coords.latitude,R=_.coords.longitude,S=np(o,w,R);l.dataset.href=S,console.log("URL actualizada con origen (si aplica):",S)},_=>{console.warn("Geoloc error:",_)},{enableHighAccuracy:!0,timeout:5e3})})})}function Su(){vs.forEach(r=>r.remove()),vs=[],Ct&&(Ct.remove(),Ct=null),X.style.display="none"}function oa(r,t){const e=encodeURIComponent("Hola, quiero hacer un pedido desde esta ubicación:"),n=Ks()?`https://maps.apple.com/?q=${encodeURIComponent(r+","+t)}`:`https://maps.google.com/?q=${encodeURIComponent(r+","+t)}`,o=`https://wa.me/593XXXXXXXXX?text=${e}%0AUbicación: ${encodeURIComponent(n)}`,u=document.querySelector("#deliveryTemplate .popup-card").cloneNode(!0);u.querySelector(".popup-title").textContent="Tu ubicación",u.querySelector(".popup-desc").innerHTML="Haz clic en el botón para pedir por WhatsApp. 👋 <br/>También puedes mover el pin para ajustar tu ubicación.",u.querySelector(".popup-btn").textContent="📲 Pedir por WhatsApp",u.querySelector(".popup-btn").addEventListener("click",()=>{window.open(o,"_blank")});const l=u.querySelector(".popup-close");l&&l.addEventListener("click",()=>{X.style.display="none"}),X.innerHTML="",X.appendChild(u);const d=At.project([t,r]);X.style.left=d.x+"px",X.style.top=d.y+"px",X.style.display="block"}function rp(){return new Promise(r=>{Su(),navigator.geolocation.getCurrentPosition(t=>{const e=t.coords.latitude,n=t.coords.longitude;Ct&&Ct.remove(),Ct=new mapboxgl.Marker({color:"red",draggable:!0}).setLngLat([n,e]).addTo(At),At.flyTo({center:[n,e],zoom:15,offset:[0,10],speed:1.2}),oa(e,n);const i=document.createElement("div");i.innerText="🚩 Arrástrame",i.style.position="absolute",i.style.background="#fff",i.style.color="#111",i.style.padding="4px 8px",i.style.borderRadius="6px",i.style.fontSize="12px",i.style.fontWeight="600",i.style.boxShadow="0 2px 6px rgba(0,0,0,0.25)",i.style.transform="translate(-50%, -160%)",i.style.whiteSpace="nowrap",Ct.getElement().appendChild(i),setTimeout(()=>i.remove(),5e3),Ct.on("dragend",()=>{const u=Ct.getLngLat();oa(u.lat,u.lng),At.flyTo({center:[u.lng,u.lat],zoom:15,offset:[0,10],speed:.6})}),r()},()=>{alert("No se pudo obtener la ubicación. Activa el GPS."),r()},{enableHighAccuracy:!0,timeout:8e3})})}At.on("load",()=>{Cu()});At.on("move",()=>{if(X.style.display==="block"&&X.querySelector(".popup-card")&&Ct){const t=Ct.getLngLat(),e=At.project([t.lng,t.lat]);X.style.left=e.x+"px",X.style.top=e.y+"px"}});const qn=document.getElementById("pickupBtn"),jn=document.getElementById("deliveryBtn");qn&&jn&&(qn.addEventListener("click",()=>{qn.classList.add("active"),jn.classList.remove("active"),sa(),setTimeout(()=>{Su(),At.flyTo({center:Gs,zoom:14,speed:1.2}),Cu(),ia()},1500)}),jn.addEventListener("click",()=>{jn.classList.add("active"),qn.classList.remove("active"),sa(),rp().finally(()=>ia())}));
